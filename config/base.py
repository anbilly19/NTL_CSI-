...
class Config:
    ...
    def __init__(self, **attrs):
        ...
        for attrname, value in attrs.items():
            if attrname in ['dataset', 'model', 'network','loss', 'shift_loss','optimizer', 'scheduler','early_stopper','trainer']:
                if attrname == 'dataset':
                ...
                if attrname == 'shift_loss':
                    setattr(self, 'shift_name', value)
    ...
    @staticmethod
    def parse_shift_loss(shift_loss):
        assert shift_loss in Config.s_loss, f'Could not find {shift_loss} in dictionary!'
        return Config.s_loss[shift_loss]
